    ...
    return(
        <div className={styles.fieldItem} key = {id}>
            ...
            {answerFormat !== 'textarea' ? 
                ...
                <input type={answerFormat} className={styles.fieldInput} placeholder={getPlaceholder(answerFormat)} defaultValue={defaultValue} required {...register(`${userRole}Responses.${id}`)} />
                :
                <textarea className={styles.fieldInput} placeholder={getPlaceholder(answerFormat)} defaultValue={defaultValue} required {...register(`${userRole}Responses.${id}`)}></textarea>
            }
        </div>
