...
class ATPTechnicianSubmission(BaseModel):
    ...
    technicianResponses: Annotated[List[Responses], Field(min_items = 0, example = [{"questionUUID": "123e4567-e89b-12d3-a456-426614174000", "spreadsheetCell": "A1", "answer": "1.0652", "answerFormat": "number"}])]
