...
class ATPSpecifiedSubmissionResponse(BaseModel):
  ...
  technicianResponses: Annotated[List[Responses], Field(description = "The responses of the technician", example = [{"questionUUID": "c4bcebc4-5d7f-4de6-b824-5941582d2545", "questionIndex": 0, "spreadsheetCell": "A2", "answer": "test response", "answerFormat": "text"}])]
