...
class ATPSpecifiedSubmissionResponse(BaseModel):
  ...
  technicianResponses: Annotated[List[Responses], Field(description = "The responses of the technician", example = [{"questionUUID": "c4bcebc4-5d7f-4de6-b824-5941582d2545", "spreadsheetCell": "A2", "answer": "test response", "answerFormat": "text"}])]
  ...
  engineerResponses: Annotated[Optional[List[Responses]], Field(description = "The responses of the engineer", example = [{"questionUUID": "59ad8436-c64c-43fd-94b1-f149fb9eb975", "spreadsheetCell": "B2", "answer": "hello world", "answerFormat": "text"}])]
  technicianStartTime: Annotated[str, Field(description = "The date and time the ATP submission was started by the technician", example = "2025-08-27T16:35:27.574041")]
  engineerStartTime: Annotated[Optional[str], Field(description = "The date and time the ATP submission was started by the engineer", example = "2025-08-27T16:35:36.940679")]
...
class ATPSubmissionMetadata(BaseModel):
  ...
  formDescription: Annotated[str, Field(description = "The description of the ATP form", example = "this is not a test description")]
  submittedBy: Annotated[str, Field(description = "The email of the user who submitted the ATP submission", example = "technician@upwingenergy.com")]
  submittedAt: Annotated[str, Field(description = "The date and time the ATP submission was submitted", example = "2025-08-27T16:14:49.274144")]
  reviewedBy: Annotated[Optional[str], Field(description = "The email of the user who reviewed the ATP submission", example = "engineer@upwingenergy.com")]
